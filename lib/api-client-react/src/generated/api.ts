...
export const listReviewers = async (
  ...
  return customFetch<ReviewerListResponse>(getListReviewersUrl(), {
    ...options,
    method: "GET",
  });
};
...
export const getListReviewersQueryKey = () => {
  return [`/api/reviewers`] as const;
};

export const getListReviewersQueryOptions = <
  TData = Awaited<ReturnType<typeof listReviewers>>,
  TError = ErrorType<ErrorResponse>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof listReviewers>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listReviewers>>> = ({
    signal,
  }) => listReviewers({ signal, ...requestOptions });
...
export type ListReviewersQueryResult = NonNullable<
  Awaited<ReturnType<typeof listReviewers>>
>;
export type ListReviewersQueryError = ErrorType<ErrorResponse>;

/**
 * @summary List all saved reviewers for the authenticated user
 */

export function useListReviewers<
  TData = Awaited<ReturnType<typeof listReviewers>>,
  TError = ErrorType<ErrorResponse>,
>(options?: {
  query?: UseQueryOptions<
 ...
 */
export const getSaveReviewerUrl = () => {
  return `/api/reviewers`;
};

export const saveReviewer = async (
  saveReviewerBody: SaveReviewerBody,
  options?: RequestInit,
): Promise<ReviewerResponse> => {
  return customFetch<ReviewerResponse>(getSaveReviewerUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(saveReviewerBody),
  });
};

export const getSaveReviewerMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof saveReviewer>>,
    TError,
    { data: BodyType<SaveReviewerBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["saveReviewer"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return saveReviewer(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SaveReviewerMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveReviewer>>
>;
export type SaveReviewerMutationBody = BodyType<SaveReviewerBody>;
export type SaveReviewerMutationError = ErrorType<ErrorResponse>;

/**
 * @summary Save a new reviewer to the archive
 */
export const useSaveReviewer = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSaveReviewerMutationOptions(options));
};

/**
 * @summary Delete a reviewer from the archive
 */
export const getDeleteReviewerUrl = (id: number) => {
  return `/api/reviewers/${id}`;
};
...
export const deleteReviewer = async (
  ...
  return customFetch<void>(getDeleteReviewerUrl(id), {
    ...options,
    method: "DELETE",
  });
};

export const getDeleteReviewerMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return deleteReviewer(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type DeleteReviewerMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteReviewer>>
>;

export type DeleteReviewerMutationError = ErrorType<ErrorResponse>;
